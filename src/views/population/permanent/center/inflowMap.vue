  ...
  export default {
    ...
    computed: {
      ...mapState({
        ...
        cityResidentFlowType: state => state.residentFlow.cityResidentFlowType,
        cityResidentFlowList: state => state.residentFlow.cityResidentFlowList
      })
    },
    watch: {
      cityResidentFlowList: function() {
        this.formatData(this.cityResidentFlowType);
      },
      cityResidentFlowType: function() {
        this.formatData(this.cityResidentFlowType);
      }
    },
    mounted() {
    ...
    methods: {
      ...
      formatData(type) {
        ...
        const _data = merge([], this.cityResidentFlowList);
